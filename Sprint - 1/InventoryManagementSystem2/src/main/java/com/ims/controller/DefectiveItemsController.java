...
public class DefectiveItemsController {
	...
	// http://localhost:8080/DefectiveItems/addDefectiveItems
	@PostMapping("DefectiveItems/addDefectiveItems")
	...
	@GetMapping("DefectiveItems/getDefectiveItems/{defectiveItemsId}")
	...
	@PutMapping("DefectiveItems/editDefectiveItems/{defectiveItemsId}")
	...
	@DeleteMapping("DefectiveItems/deleteDefectiveItems/{defectiveItemsId}")
	...
	@GetMapping("DefectiveItems/getDefectiveItems")
