...
import com.ims.exception.SupplierIdNotFoundException;
...
public class SupplierServiceImpl implements SupplierService
{
	...
	{
		return supplierRepository.findById(supplierId).orElseThrow( ()-> new SupplierIdNotFoundException("Supplier id is not found"));
	}

	@Override
	public Supplier updateSupplierDetails(Supplier supplier, int supplierId) 
	{
		Supplier updateSupplier = supplierRepository.findById(supplierId).orElseThrow( ()-> new SupplierIdNotFoundException("Supplier id is not correct"));
	...
	{
		supplierRepository.findById(supplierId).orElseThrow( ()-> new SupplierIdNotFoundException("Supplier id is not correct"));
